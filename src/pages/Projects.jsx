          ...
          <div className="bg-[#212529] text-gray-600 rounded-sm p-4 sm:p-6 my-6 container mx-auto">
            <form onSubmit={handleSubmit}>
              <div className="space-y-4">
                ...
                <button
                  type="submit"
                  className="px-6 py-3 bg-blue-600 text-white font-semibold rounded-lg shadow-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-offset-2 transition-all duration-300"
                >
                  Submit
                </button>
                </div>
