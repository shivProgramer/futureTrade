...
//           <MdPhoneInTalk  size={35} className="bg-[#BB9532] text-white p-2 rounded-full"/>
//           <MdOutlineEmail  size={35} className="bg-[#BB9532] text-white p-2 rounded-full"/>
//          </div>
...
//               <NavLink
//                 to="/"
//                 className="block py-2 px-3 text-gray-700 border-r-2 font-normal text-sm border-gray-300"
//                 aria-current="page"
...
//               <NavLink
//                 to="/services"
//                 className="block py-2 px-3 text-gray-800  border-r-2 font-normal text-sm "
//                 onClick={closeMenu} // Close menu when clicked
//               >
//                Login
//               </NavLink>
